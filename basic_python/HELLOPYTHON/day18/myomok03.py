...
class WindowClass(QMainWindow, form_class) :
    ...
    def pbFunction(self):
        ...
        self.history_arr = list(reduce(lambda x, y: x+y, self.arr2d))
        
        print(self.history_arr)
        
        self.all_history_arr.append(self.history_arr)
        
        print(self.all_history_arr) #history가 들어간 배열임
        ...
        if d1 == 5 or d2 == 5 or d3 == 5 or d4 == 5 :
            ...
            if self.flag_wb :
                ...
                from day18 import gibo
                
                gibo.omok_insert(self.all_history_arr, 1)
                ...
                gibo.omok_insert(self.all_history_arr, 2)
