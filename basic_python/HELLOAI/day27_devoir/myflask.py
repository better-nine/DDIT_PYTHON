...
import cx_Oracle 
from day27_devoir.mydao_suser import MyDao_Suser
from day27_devoir.mydao_survey import MyDao_Survey
from day27_devoir.mydao_detail import MyDao_Detail
from day27_devoir.mydao_starget import MyDao_Starget
from day27_devoir.mydao_sresult import MyDao_Sresult
from day27_devoir.mymail import Mymail
...
def sview():
    ...
    return render_template('sview.html', list=list, survey_id=survey_id,st_mobile=st_mobile)


@app.route('/sview_insert', methods=['POST'])
def sview_insert():
...
def writeHistory(pan, history, win):
    ...
    sql_str = "insert into sview(pan, pseq, history, win) values(:1,:2,:3,:4)"
