...
class WindowClass(QMainWindow, form_class) :
    ...
    def pbFunction(self):
        ...
        if self.flag_wb == True :
            ...
            user_stone = 1
            ##################################################
            rand_01 = random.randint(0,9)
            rand_02 = random.randint(0,9)
            
            self.arr2d[rand_01][rand_02] = 2
            com_stone = 2
        
        up = self.getUP(int_i, int_j, user_stone)
        do = self.getDW(int_i, int_j, user_stone)
        le = self.getLE(int_i, int_j, user_stone)
        re = self.getRI(int_i, int_j, user_stone)
                                    
        dl = self.getDL(int_i, int_j, user_stone)
        dr = self.getDR(int_i, int_j, user_stone)
        ul = self.getUL(int_i, int_j, user_stone)
        ur = self.getUR(int_i, int_j, user_stone)
